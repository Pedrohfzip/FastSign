// Tela de assinatura para o PRÓPRIO usuário logado (dono do documento).
// Usa o mesmo fluxo de accessToken que o PublicSign, mas fica atrás de login (ProtectedRoute).
import React, { useState, useEffect } from "react";
import { useParams, useNavigate } from "react-router";
import { motion } from "framer-motion";
import { FileText, PenLine, CheckCircle2, Loader2, AlertCircle, ArrowLeft } from "lucide-react";
                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            <p className="text-sm text-gray-400">
                                Sua assinatura em <strong>{data?.document?.title}</strong> foi registrada com sucesso.
                            </p>
                            <motion.button
                        ...
                        <>
                            ...
                            <h1 className="text-xl font-semibold text-white">Assinar documento</h1>
                            <p className="text-sm text-gray-400">
                                O documento <strong>{data?.document?.title}</strong> está pronto para sua assinatura.
                            </p>
