...
const DocumentViewer = ({ documentId, onBack }) => (
    <div className="flex flex-col h-full">
        ...
        <div className="md:hidden flex items-center gap-2 p-3 bg-white border-b border-gray-200">
            <button
                onClick={onBack}
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="flex h-[calc(100vh-57px)]">
                ...
                {/* No mobile: ocupa tela cheia quando não há doc selecionado */}
                {/* No desktop: sempre visível na esquerda */}
                <div className={`
                    bg-white border-r border-gray-200 flex flex-col
                    ${selectedDocumentId ? 'hidden md:flex md:w-80' : 'flex w-full md:w-80'}
                `}>
                ...
                {/* Área do PDF */}
                {/* No mobile: ocupa tela cheia quando há doc selecionado */}
                {/* No desktop: sempre visível na direita */}
                <div className={`
                    flex-1
                    ${selectedDocumentId ? 'flex flex-col' : 'hidden md:flex md:items-center md:justify-center'}
                `}>
                    {selectedDocumentId ? (
                        <DocumentViewer
