...
export default function UploadScreen({ onContinue }) {
    ...
    return (
        <div
            className="w-full min-h-screen bg-[#0b0b12] text-white flex flex-col"
            ...
            <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-16">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="relative cursor-pointer rounded-2xl border border-dashed flex flex-col items-center justify-center gap-4 py-14 px-8 select-none"
                    >
                        <motion.div
                    ...
                    {/* Lista de arquivos com status real de upload */}
                    <AnimatePresence>
                        {items.length > 0 && (
                            <motion.ul
